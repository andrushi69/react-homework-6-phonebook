...
import {addContactItem} from "../../redux/Contacts/ContactsAction"
...
const Form = () => {
  ...
  const onAddContactItem = (name, number) => dispatch(addContactItem(name, number));
  ...
  const handleSubmit = (e) => {
    ...
    if (contacts.contactsReducer.find(contact => contact.name === name)) {
